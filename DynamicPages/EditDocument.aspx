            ...
            <table border="0" width="800">
                    ...
                    <tr>
                        <td colspan="2" align="left">
                            Document Name:  <%# Eval("doc_name") %></td>
                            <td><asp:HyperLink ID="hlReturn" runat="server" Text="Return to Manage Dynamic Pages" NavigateUrl="~/DynamicPages/ManageDynamicPages.aspx"></asp:HyperLink>
                            </td>
                    </tr>
                    <tr style="height:300px" >
                        ...
                        <FTB:FreeTextBox id="FreeTextBox1" runat="Server" Text='<%# Bind("doc_content") %>' />
                            ...
                            <asp:RequiredFieldValidator ID="rfvHtext" runat="server" ErrorMessage="Enter Content"
