<%@ Page Language="VB" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="false"
    CodeFile="ManageActiveMktgItems.aspx.vb" Inherits="Product_ManageActiveMktgItems" %>
                    ...
                    <tr>
                        <td style="width: 182px">All Products<br />
                            ...
                            <asp:SqlDataSource ID="dsMktgProducts" runat="server" ConnectionString="<%$ ConnectionStrings:BaseDBConnection %>"
                                SelectCommand="MANAGERGetAllMarketingProducts" SelectCommandType="StoredProcedure">
                            </asp:SqlDataSource>
                        </td>
                        <td style="width: 3px">
                            <asp:Button ID="btnMoveRight" runat="server" Text=">>>>" />
                            <asp:Button ID="btnMoveLeft" runat="server" Text="<<<<" /></td>
                        <td>Marketing Products<br />
                            ...
                            <asp:SqlDataSource ID="dsNonMktgProducts" runat="server" ConnectionString="<%$ ConnectionStrings:BaseDBConnection %>"
                                SelectCommand="MANAGERGetAllNONMarketingProducts" SelectCommandType="StoredProcedure">
                            </asp:SqlDataSource>
                        </td>
                    </tr>
                 </table>
