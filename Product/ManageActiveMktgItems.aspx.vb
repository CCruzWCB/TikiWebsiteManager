...
Partial Class Product_ManageActiveMktgItems
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Master.PageHeader = "Manage Active Marketing Products"
        Me.Master.PageTitle = "Manage Active Marketing Products "
        Me.Master.SetDisplayMessage("Welcome to Active Marketing Products Management", MessageType.GeneralMessage)
    ...
    Public Function UpdateCurrentMKTGProduct(ByVal ProductID As Integer, ByVal IsActiveOnMktgSite As Boolean) As Boolean
        ...
        Try    'Only one "Try" statement 
            ...
            SQLCommand.CommandText = "LLFBPS..[MANAGERAddMktgProduct]"     'Stored Procedure Name
            ...
            SQLCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsActiveOnMktgSite", System.Data.SqlDbType.Bit, 4))


            SQLCommand.Parameters("@ProductID").Value = ProductID
            SQLCommand.Parameters("@IsActiveOnMktgSite").Value = IsActiveOnMktgSite
